...
public class VehiculoController {
	...
	public String update(@PathVariable(value="id") Integer id, Model model) {
		Vehiculo vehiculo = service.findById(id);
		model.addAttribute("antecedentepatologico", vehiculo);
		model.addAttribute("title", "Actualizar un vehículo");
		return "vehiculo/form";
	}
	...
	public String save(Vehiculo vehiculo, Model model, RedirectAttributes flash) {
		try {
			service.save(vehiculo); //El service ya sabe si es nuevo o un antiguo y lo actualiza
